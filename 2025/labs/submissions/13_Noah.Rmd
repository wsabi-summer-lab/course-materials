...
putts_train = read_csv("~/Documents/GitHub/summer-lab/2025/labs/data/13_putts-train.csv.gz")
...
# —————————————————————————————
putts_train = read_csv("~/Documents/GitHub/summer-lab/2025/labs/data/13_putts-train.csv.gz")
putts_test = read_csv("~/Documents/GitHub/summer-lab/2025/labs/data/13_putts-test.csv.gz")
