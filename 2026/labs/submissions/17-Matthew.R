...
formation_valid_log_loss = log_loss(valid$playActionPass, formation_valid)
formation_test_log_loss = log_loss(test$playActionPass, formation_test)

formation_valid_log_loss
formation_test_log_loss
...
comparison = tibble(
  ...
  selected_tuning = c(
    ...
    paste0("depth=", best_xgb_row$max_depth,
           ", eta=", best_xgb_row$eta,
           ", min_child=", best_xgb_row$min_child_weight)
  ),
